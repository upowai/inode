...
class WalletRepository:
    ...
    def get_address_info(
        ...
        # tx_inputs = []
        # pending_spent_outputs = [(output['tx_hash'], output['index']) for output in result['pending_spent_outputs']]
        ...
        # stake_tx_input = []
        # if stake_outputs:
        #     for stake_tx_input in result['stake_outputs']:
        #         if (stake_tx_input['tx_hash'], stake_tx_input['index']) in pending_spent_outputs:
        #             continue
        #         tx_input = TransactionInput(stake_tx_input['tx_hash'], stake_tx_input['index'])
        #         tx_input.amount = Decimal(str(stake_tx_input['amount']))
        #         tx_input.public_key = string_to_point(address)
